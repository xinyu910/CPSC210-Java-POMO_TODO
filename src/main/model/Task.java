...
public class Task extends Todo {
    ...
    public void addTag(String tagName) {
        if (tagName == null || tagName.isEmpty()) {
            throw new EmptyStringException("Invalid tag name");
        }
    ...
    public void addTag(Tag tag) {
        if (tag == null) {
            throw new NullArgumentException("Illegal argument: tag is null");
        }
        if (!containsTag(tag)) {
            tags.add(tag);
            tag.addTask(this);
    ...
    public void removeTag(String tagName) {
        if (tagName == null || tagName.length() == 0) {
            throw new EmptyStringException("tagName is empty or null");
        }
